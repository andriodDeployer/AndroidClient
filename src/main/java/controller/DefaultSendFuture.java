...
public class DefaultSendFuture {
    ...
    private static final ConcurrentMap<Long, DefaultSendFuture> futures = new ConcurrentHashMap<>();
    ...
    public static DefaultSendFuture with(long requestId,Channel channel){
        return with(requestId,channel,DEFAULT_TIMEOUT_NANOSECOND);
    }

    public static DefaultSendFuture with(long requestId,Channel channel,long timeout){
    ...
    private DefaultSendFuture(long requestId, Channel channel, long timeout){
    ...
    public static void received(Channel jChannel, GResponse response){
     ...
     * @param response
     */
    private void doReceived(Channel channel,GResponse response){
    ...
    private void handleException(Channel channel,GResponse response) {
    ...
    public static void fakeReceived(Channel channel,GResponse response){
